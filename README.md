...
[Open in Google Colab](https://colab.research.google.com/github/letsslipaway/btc_price_prediction/tree/main/model/blob/main/BTC_price_prediction.ipynb)
...
1. **Clone the repository:**
   ...
   cd btc_price_prediction/tree/main/model
   ```
